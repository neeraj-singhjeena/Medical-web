...
const Assistant = () => {
  ...
  const knowledgeBase = {
    greetings: {
      ...
      response:
        "Hello! I'm your business assistant. How can I help you with our services and industries today?",
    ...
    default: {
      response:
        "I'm not sure I understand. Could you please rephrase your question or choose from the options below?",
      options: ["Services", "Industries", "Contact", "About Us"],
    },
  };
  ...
  const commonQuestions = [
    {
      label: "Chemical Services",
      question: "Tell me about chemical industry services",
    },
    {
      label: "Construction",
  ...
  const findResponse = (message) => {
    ...
    for (const [key, data] of Object.entries(knowledgeBase)) {
      if (
        data.patterns &&
        data.patterns.some((pattern) => lowerMessage.includes(pattern))
      ) {
        return data;
      }
    }
  ...
  const handleOptionSelect = (option) => {
    ...
    setTimeout(() => {
      ...
      if (
        option.includes("Chemical") ||
        option.includes("Process") ||
        option.includes("Quality") ||
        option.includes("Regulatory")
      ) {
        response = knowledgeBase.chemical;
      } else if (
        option.includes("Construction") ||
        option.includes("Project") ||
        option.includes("Safety")
      ) {
        ...
        option.includes("Government") ||
        option.includes("Policy") ||
        option.includes("Regulatory")
      ) {
        response = knowledgeBase.government;
      } else if (
        option.includes("Data") ||
        option.includes("Analytics") ||
        option.includes("Business Intelligence")
      ) {
        response = knowledgeBase.data;
      } else if (
        option.includes("AI") ||
        option.includes("Machine Learning") ||
        option.includes("ML")
      ) {
        response = knowledgeBase.ai;
      } else if (
        option.includes("Cloud") ||
        option.includes("Migration") ||
        option.includes("Infrastructure")
      ) {
        response = knowledgeBase.cloud;
      } else if (
        option.includes("Consulting") ||
        option.includes("Strategic") ||
        option.includes("Planning")
      ) {
        response = knowledgeBase.consulting;
      } else if (
        option.includes("Contact") ||
        option.includes("Schedule") ||
        option.includes("Call")
      ) {
  ...
  return (
    <>
      ...
      >
        <img src="/images/Footer/Assistant/robot.png" alt="Chat Assistant" />
      </button>
